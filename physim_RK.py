...
def animate(i, lines, pts, xplot, yplot, zplot):
...
anim = animation.FuncAnimation(fig3, animate,  fargs=(lines, pts, xplot, yplot, zplot), frames=int(len(range(timesteps))/throttle_ip), interval=100,  blit=True)
anim
plt.show()
